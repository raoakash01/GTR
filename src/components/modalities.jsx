...
function Modalities() {
    return(
        <div className="modalities">
            ...
            <p className="modalities-text">We have our footprints across India and various offshore locations. 
                Our large team of senior and experienced radiologists are competent to report on all modalities 
                across all sub-specialties.</p>
